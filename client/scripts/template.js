angular.module('fitspector').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('views/directives/screen-size.html',
    "<div><span>Current screen size:</span> <span class=\"visible-lg\">Large</span> <span class=\"visible-md\">Merdium</span> <span class=\"visible-sm\">Small</span> <span class=\"visible-xs\">Extra small</span></div>"
  );
